...
def check_cac40_orb():
    ...
    # Calcolo Indicatori EMA 200 e ATR 14
    ...
    # Breakout LONG (Scatta SOLO sulla prima candela di rottura sopra EMA 200)
    ...
    # Breakdown SHORT (Scatta SOLO sulla prima candela di rottura sotto EMA 200)
